...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.1');" href="#"><i id="ex1.1" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.2');" href="#"><i id="ex1.2" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.3');" href="#"><i id="ex1.3" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.1');" href="#"><i id="ex1.4" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.5');" href="#"><i id="ex1.5" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.6');" href="#"><i id="ex1.6" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.7');" href="#"><i id="ex1.7" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.8');" href="#"><i id="ex1.8" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.1');" href="#"><i id="ex1.9" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.10');" href="#"><i id="ex1.10" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.11');" href="#"><i id="ex1.11" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.12');" href="#"><i id="ex1.12" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.13');" href="#"><i id="ex1.13" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.14');" href="#"><i id="ex1.14" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.1');" href="#"><i id="ex1.15" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.16');" href="#"><i id="ex1.16" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.17');" href="#"><i id="ex1.17" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.18');" href="#"><i id="ex1.18" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.19');" href="#"><i id="ex1.19" class="fas fa-bookmark" style="color:white"></i></button>
...
<div class="card">
    <div class="card-header p-2">
        ...
        <button type="button" class="btn btn-dark float-right" onclick="bookmark('ex1.20');" href="#"><i id="ex1.20" class="fas fa-bookmark" style="color:white"></i></button>
